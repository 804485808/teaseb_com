...
//	  $uri = str_replace($thisurl,"http://".$replace.".motors-biz.com/",$uri);
	  $uri = str_replace($thisurl,"http://m.motors.com/company/companyDetail/".$replace,$uri);
	  return $uri;
	}
}
...
if (!function_exists('site_url_mob'))
{
    function site_url_mob($uri = '',$imgwidth,$imgheight)
    {
       return myImageResize($uri,$imgwidth,$imgheight);
    }
}
